...
"""Write a method that receives the height of a diamond. The method will be to print the following way:
Height: 7
 ...
 *****
  ***
   *
Accept odd numbers only for the height of the height."""

def main():
    n = int(input("Give me a number..."))  # stores the number to be used on the diamonds
    s = '*'
