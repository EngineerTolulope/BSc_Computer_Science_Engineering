...
inhom3d n1 = new inhom3d( 0.0, 1.0, 0.0 ); //inserting only x,y,z
inhom3d n2 = new inhom3d( 0.0, 0.0, 1.0 );
inhom3d n3 = new inhom3d( 1.0, 0.0, 0.0 );
inhom3d n4 = new inhom3d( 0.0, 0.0, -1.0 );
inhom3d n5 = new inhom3d( -1.0, 0.0, 0.0 );
inhom3d n6 = new inhom3d( 0.0, -1.0, 0.0 );
...
void draw ( ) {
  ...
  mult( matrixRx, matrixRy, A );//We get the A transformation matrix
  ...
  hom3d   n1h  = n1.toHom3d( );  
  hom3d   n2h  = n2.toHom3d( );
  hom3d   n3h  = n3.toHom3d( );
  hom3d   n4h  = n4.toHom3d( );
  hom3d   n5h  = n5.toHom3d( );
  hom3d   n6h  = n6.toHom3d( );
  ...
  hom3d   n1h_ = n1h.appMatrix( A );
  hom3d   n2h_ = n2h.appMatrix( A );
  hom3d   n3h_ = n3h.appMatrix( A );
  hom3d   n4h_ = n4h.appMatrix( A );
  hom3d   n5h_ = n5h.appMatrix( A );
  hom3d   n6h_ = n6h.appMatrix( A );
  ...
  inhom3d n1_ = n1h_.toInhom3d( );
  inhom3d n2_ = n2h_.toInhom3d( );
  inhom3d n3_ = n3h_.toInhom3d( );
  inhom3d n4_ = n4h_.toInhom3d( );
  inhom3d n5_ = n5h_.toInhom3d( );
  inhom3d n6_ = n6h_.toInhom3d( );
  ...
  stroke(0,0,255);
   if ( n1_.z > 0 ) //checking if the plane is visible
  {
    /*line( C1_.x, C1_.y, C2_.x, C2_.y );
    line( C2_.x, C2_.y, C6_.x, C6_.y );
    line( C6_.x, C6_.y, C5_.x, C5_.y );
    line( C5_.x, C5_.y, C1_.x, C1_.y );*/
    fill(255,0,0);
    quad(C1_.x,C1_.y,C2_.x,C2_.y,C6_.x,C6_.y,C5_.x,C5_.y);
  }
  if ( n2_.z > 0 )
  {
    ...
    fill(255,255,0);
    quad(C5_.x,C5_.y,C6_.x,C6_.y,C7_.x,C7_.y,C8_.x,C8_.y);
  }
  if ( n3_.z > 0 )
  {
   /* line( C4_.x, C4_.y, C1_.x, C1_.y );
    line( C1_.x, C1_.y, C5_.x, C5_.y );
    line( C5_.x, C5_.y, C8_.x, C8_.y );
    line( C8_.x, C8_.y, C4_.x, C4_.y );
   */
    fill(0,255,0);
    quad(C4_.x,C4_.y,C1_.x,C1_.y,C5_.x,C5_.y,C8_.x,C8_.y);
  }
  if ( n4_.z > 0 )
  {
    /*line( C2_.x, C2_.y, C1_.x, C1_.y );
    line( C1_.x, C1_.y, C4_.x, C4_.y );
    line( C4_.x, C4_.y, C3_.x, C3_.y );
    line( C3_.x, C3_.y, C2_.x, C2_.y );*/
    fill(0,255,255);
    quad(C2_.x,C2_.y,C1_.x,C1_.y,C4_.x,C4_.y,C3_.x,C3_.y);
  }
  if ( n5_.z > 0 )
  {
    /*line( C2_.x, C2_.y, C6_.x, C6_.y );
  ...
  */
   fill(255);
   quad(C2_.x,C2_.y,C6_.x,C6_.y,C7_.x,C7_.y,C3_.x,C3_.y);
}
  if ( n6_.z > 0 )
  {
    /*
    line( C4_.x, C4_.y, C8_.x, C8_.y );
    line( C8_.x, C8_.y, C7_.x, C7_.y );
    line( C7_.x, C7_.y, C3_.x, C3_.y );
    line( C3_.x, C3_.y, C4_.x, C4_.y );
  */
   fill(0,0,255);
    quad(C4_.x,C4_.y,C8_.x,C8_.y,C7_.x,C7_.y,C3_.x,C3_.y);
}
