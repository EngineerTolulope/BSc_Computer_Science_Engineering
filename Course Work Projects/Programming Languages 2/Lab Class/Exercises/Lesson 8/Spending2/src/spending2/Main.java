...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (fsc.hasNextLine()) {//while there is a next line
                ...
                try {
                    expensesList.add(new Expense(name, price, new MyDate(year, month, day)));
                } catch (InvalidDateException ex) {
                    System.err.println("Invalid date: " + year + " " + month + " " + day);
                    try {
                        expensesList.add(new Expense(name, price, new MyDate(1999, 1, 1)));
    ...
    public static void printExpenses(List<Expense> expList){
